function output = run_ECDSA_sim_parfor(run_param, output, user_loop, sim_length)
% Master file for running ECDSA design and simulation using parfor
% Andrew Neish 2/3/2019

% Set variables
run_param.user_loop = user_loop;
run_param.OTAR_num = sim_length;
