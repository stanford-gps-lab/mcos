...
omtConfig = {...
    1, teslaKeyLengthBits + teslaSaltLengthBits + level2PublicKeyLengthBits*3/2, 'TESLA current keychain root/intermediate key, salt, and level 2 signature';...
...
notes = 'OMT 1 signature length fixed compared to TESLA_RevC_ECSchnorr';
