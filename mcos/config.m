...
if nargin < 1 % Skip if plotData is being called
    ...
    scheme = 'ECSchnorr'; % Scheme - 'TESLA', 'ECDSA', or 'ECSchnorr'
    ...
    weightingSchemeFile = 'Hameed-Standard-ECSchnorr-RevA-100.mat';   % WeightingSchemeFile - Can be an array for sensitivity analyses.
    omtConfigurationFile = 'ECSchnorr_RevA.mat';  % MessageConfiguration - File containing message configuration information.
    ...
    if (strcmpi(scheme, 'ECSchnorr')) || (strcmpi(omtConfigurationFile, 'TESLA_RevC_ECSchnorr.mat'))
        level1SignatureLengthBits = 384*3/2;  % Level1SignatureLengthBits - Length of the level-1 signature in bits
        level2SignatureLengthBits = 224*3/2;  % Level2SignatureLengthBits - Length of the level-2 siganture in bits
    else
        level1SignatureLengthBits = 384*2;  % Level1SignatureLengthBits - Length of the level-1 signature in bits
        level2SignatureLengthBits = 224*2;  % Level2SignatureLengthBits - Length of the level-2 siganture in bits
    end
...
if nargin < 1
    configParameters = mcos.ConfigParameters(...
        ...
        'MessageAuthenticationLength', messageAuthenticationLength,...
        'PER', per,...
        ...
        'Level1SignatureLengthBits', level1SignatureLengthBits,...
        'Level2SignatureLengthBits', level2SignatureLengthBits,...
